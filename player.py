...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,filename):
        ...
        img = pygame.image.load("C:/Users/Admin/Desktop/pacman/PacMan-Python-master/PacMan/walk.png").convert()
        ...
        img = pygame.image.load("C:/Users/Admin/Desktop/pacman/PacMan-Python-master/PacMan/explosion.png").convert()
    ...
    def update(self,horizontal_blocks,vertical_blocks):
        if not self.explosion:
            ...
            for block in pygame.sprite.spritecollide(self,horizontal_blocks,True):
