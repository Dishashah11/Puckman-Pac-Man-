...
class Game(object):
    def __init__(self):
        ...
        # Create the player
        self.player = Player(32,128,"C:/Users/Admin/Desktop/pacman/PacMan-Python-master/PacMan/player.png")
        ...
        self.pacman_sound = pygame.mixer.Sound("C:/Users/Admin/Desktop/pacman/PacMan-Python-master/PacMan/Footstep on sand 1.mp3")
        self.game_over_sound = pygame.mixer.Sound("C:/Users/Admin/Desktop/pacman/PacMan-Python-master/PacMan/game_over_sound.ogg")
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                ...
                Fact = '''The objective of the game is to eat all of the dots placed in the maze while avoiding colored ghosts later it reaches next level, If a ghost ever catches Pac-Man then Pac-Man is defeated.\nCreated by: \n Disha Shah \n Maitri Sharma'''
                msg='''The objective of the game is to eat all of 
                \n the dots placed in the maze while avoiding colored ghosts later 
                it reaches next level, If a ghost ever catches Pac-Man then Pac-Man is defeated.
                \nCreated by: \n Disha Shah \n Maitri Sharma'''
                self.display_message(screen,Fact)
